    ...
    try:
        ...
        if channel:
            try:
                ...
                return jsonify({'error': 'Invalid channel value'}), 400
...
def register_push_token():
    ...
    try:
        ...
        return jsonify({'message': 'Push token registered successfully'})
...
def unregister_push_token():
    ...
    try:
        ...
        return jsonify({'message': 'Push token unregistered successfully'})
...
def get_notification_channels():
    ...
    try:
        ...
        return jsonify({'error': 'Failed to get notification channels'}), 500
...
def send_bulk_notification():
    ...
    try:
        ...
        if not isinstance(user_ids, list) or len(user_ids) > 1000:
            return jsonify({'error': 'Invalid user_ids or too many recipients (max 1000)'}), 400
        ...
        return jsonify({'error': 'Failed to send bulk notification'}), 500
...
def get_delivery_reports():
    ...
    try:
        ...
        return jsonify({'error': 'Failed to get delivery reports'}), 500