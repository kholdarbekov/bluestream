...
from business_app.utils.timezone_utils import (
    get_user_timezone, utc_to_local, local_to_utc, 
    parse_user_datetime, ensure_utc
)
...
class TimezoneMiddleware:
    ...
    def _convert_request_datetimes(self, data, source_tz=None):
        ...
        datetime_fields = [
            ...
            'start_time', 'end_time', 'scheduled_at',
            'delivery_time', 'preferred_delivery_time',
            'expires_at', 'valid_until', 'date_of_birth',
            'last_login', 'verified_at', 'paid_at'
        ]
    ...
    def _convert_response_datetimes(self, data, target_tz=None):
        ...
        datetime_fields = [
            ...
            'expires_at', 'valid_until', 'last_login',
            'verified_at', 'paid_at', 'delivered_at',
...
def convert_model_datetimes_to_user_tz(model_dict, timezone_tz=None):
    ...
    datetime_fields = [
        'created_at', 'updated_at', 'deleted_at',
        'last_login', 'verified_at', 'paid_at',
        'delivered_at', 'confirmed_at', 'cancelled_at',
        'expires_at', 'valid_until', 'scheduled_at'
    ]
