...
def upgrade():
    ...
    op.create_table('driver_cash_sessions',
    ...
    with op.batch_alter_table('driver_cash_sessions', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_driver_cash_sessions_blocked_from_cod'), ['blocked_from_cod'], unique=False)
        ...
        batch_op.create_index(batch_op.f('ix_driver_cash_sessions_submitted_by_user_id'), ['submitted_by_user_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_driver_cash_sessions_verified_by_user_id'), ['verified_by_user_id'], unique=False)

    op.create_table('cash_collection_events',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('cash_collection_events', schema=None) as batch_op:
        batch_op.create_index('idx_cash_collection_events_collector_occurred', ['collector_user_id', 'occurred_at'], unique=False)
        batch_op.create_index('idx_cash_collection_events_customer_created', ['customer_id', 'created_at'], unique=False)
        batch_op.create_index('idx_cash_collection_events_source_occurred', ['source', 'occurred_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_cash_collection_events_collector_user_id'), ['collector_user_id'], unique=False)
        ...
        batch_op.create_index(batch_op.f('ix_cash_collection_events_driver_cash_session_id'), ['driver_cash_session_id'], unique=False)
        ...
        batch_op.create_index(batch_op.f('ix_cash_collection_events_recorded_by_user_id'), ['recorded_by_user_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_cash_collection_events_source'), ['source'], unique=False)
        batch_op.create_index(batch_op.f('ix_cash_collection_events_voided_by_user_id'), ['voided_by_user_id'], unique=False)

    op.create_table('cash_collection_allocations',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['cash_collection_event_id'], ['cash_collection_events.id'], ),
    sa.ForeignKeyConstraint(['order_id'], ['orders.id'], ),
    sa.ForeignKeyConstraint(['payment_id'], ['payments.id'], ),
    sa.ForeignKeyConstraint(['reversed_by_user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('cash_collection_event_id', 'payment_id', 'allocation_order', name='uq_cash_collection_allocations_event_payment_order')
    )
    with op.batch_alter_table('cash_collection_allocations', schema=None) as batch_op:
        batch_op.create_index('idx_cash_collection_allocations_event_created', ['cash_collection_event_id', 'created_at'], unique=False)
        batch_op.create_index('idx_cash_collection_allocations_payment_created', ['payment_id', 'created_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_cash_collection_allocations_cash_collection_event_id'), ['cash_collection_event_id'], unique=False)
        ...
        batch_op.create_index(batch_op.f('ix_cash_collection_allocations_reversed_by_user_id'), ['reversed_by_user_id'], unique=False)

    with op.batch_alter_table('payments', schema=None) as batch_op:
        batch_op.add_column(sa.Column('collected_by', sa.Integer(), nullable=True))
        batch_op.add_column(sa.Column('amount_collected', sa.Numeric(precision=12, scale=2), nullable=False, server_default='0'))
        batch_op.add_column(sa.Column('outstanding_amount', sa.Numeric(precision=12, scale=2), nullable=False, server_default='0'))
