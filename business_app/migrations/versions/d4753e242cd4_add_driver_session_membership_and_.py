...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('active', 'left', 'revoked', name='driver_session_membership_status'), nullable=False),
    ...
    with op.batch_alter_table('driver_bottle_session_orders', schema=None) as batch_op:
        ...
        batch_op.create_index(
            ...
            ['accepted_by_driver_id'], unique=False,
        )
        batch_op.create_foreign_key(
            'fk_dbso_accepted_by_driver',
            'users', ['accepted_by_driver_id'], ['id'],
        )
