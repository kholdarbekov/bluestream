...
def expire_loyalty_points() -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(
            ...
            f"{expired_count} points expired for {affected_users} users"
        )
...
def process_pending_referral_rewards() -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(
            f"Referral rewards processed: {processed_count} referrals, "
            f"{total_points_awarded} points awarded"
        )
...
def update_loyalty_tiers() -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(
            f"Loyalty tiers updated: {len(upgrades)} upgrades, {len(downgrades)} downgrades"
        )
