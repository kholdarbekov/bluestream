...
class FileValidator:
    ...
    def validate_file_content(
        self, file: BinaryIO, filename: str, expected_category: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def _contains_path_traversal(self, path: str) -> bool:
        ...
        dangerous_patterns = [
            ...
            "....\\",  # Multiple dots
            ".%2f",
            ".%5c",  # Dot with encoded slash
            "/%2e%2e",
            "\\%2e%2e",  # Leading slash with encoded
        ]
    ...
    def _validate_image_content(self, file: BinaryIO, results: Dict[str, Any]):
        ...
        try:
            ...
            with Image.open(file) as img:
                ...
                # Store image info
                results["image_info"] = {"width": width, "height": height, "format": img.format, "mode": img.mode}
