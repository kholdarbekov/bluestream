...
class SecuritySensitiveFilter(logging.Filter):
    ...
    SENSITIVE_KEYS = {
        ...
        'refresh_token', 'card_number', 'cvv', 'ssn', 'passport'
    }
    ...
    def _sanitize_value(self, value):
        ...
        if isinstance(value, dict):
            return {k: '***REDACTED***' if any(sens in k.lower() for sens in self.SENSITIVE_KEYS)
...
class SecurityLogger:
    ...
    def log_permission_denied(self, user_id: int, resource: str, action: str, 
                            ip_address: str, additional_info: Dict = None):
    ...
    def log_data_access(self, user_id: int, resource: str, action: str,
                       record_count: int = None, additional_info: Dict = None):
...
class BusinessLogger:
    ...
    def log_delivery_event(self, delivery_id: int, event: str, order_id: int = None,
                          driver_id: int = None, additional_info: Dict = None):
    ...
    def log_inventory_event(self, product_id: int, event: str, quantity: int = None,
                           user_id: int = None, order_id: int = None,
                           additional_info: Dict = None):
...
class DatabaseQueryLogger:
    ...
    def log_query(self, query: str, duration: float, result_count: int = None,
