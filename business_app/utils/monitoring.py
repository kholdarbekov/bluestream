...
from business_app.utils.logging_config import performance_logger, security_logger
...
def monitor_request_performance(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        try:
            ...
            # Record metrics
            app_metrics.record_timer('request_duration', duration, {
                'endpoint': request.endpoint or 'unknown',
                'method': request.method,
                'status': 'success'
            })
            
            app_metrics.increment_counter('requests_total', 1, {
                'endpoint': request.endpoint or 'unknown',
                'method': request.method,
                'status': 'success'
            })
            ...
            app_metrics.increment_counter('request_errors', 1, {
                'endpoint': request.endpoint or 'unknown',
                'method': request.method,
