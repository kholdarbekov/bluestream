    ...
    def decorator(f):
        ...
        def decorated_function(*args, **kwargs):
            ...
            try:
                ...
                return jsonify({"error": "Validation failed", "validation_errors": errors, "details": e.errors()}), 400
...
def create_error_response(
    error: str, status_code: int = 400, validation_errors: Optional[list] = None, **extra_fields
) -> tuple:
    """
    ...
    """
    response = {"success": False, "error": error, **extra_fields}
...
def paginated_response(
    items: list, pagination_obj, item_serializer: Optional[Type[BaseModel]] = None, **extra_fields
) -> Dict[str, Any]:
    """
...
def handle_model_errors(func):
    ...
    def wrapper(*args, **kwargs):
        try:
            ...
            return create_error_response("Validation failed", status_code=400, validation_errors=errors)
