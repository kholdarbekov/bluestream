...
def log_service_call(
    operation_type: str = "general", log_args: bool = False, log_result: bool = False, track_performance: bool = True
):
    """
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                # Execute the method
                with performance_logger.measure_time(operation_name, operation_type=operation_type, user_id=user_id):
                ...
                if track_performance:
                    ...
                    app_metrics.record_timer(
                        ...
                        duration,
                        {"service": service_name, "method": method_name, "operation_type": operation_type},
                    )
        ...
        def wrapper(*args, **kwargs):
            ...
            if entity_type == "order":
                ...
                business_logger.log_delivery_event(
                    ...
                    driver_id=(
                        getattr(result, "delivery_person_id", None) if hasattr(result, "delivery_person_id") else None
                    ),  # noqa: E501
                    additional_info=additional_info,
                )
            else:
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                # Track metrics
                app_metrics.record_timer(
                    "database_query_duration", duration, {"operation": operation_type, "function": func.__name__}
                )

                app_metrics.increment_counter(
                    "database_queries_total",
                    1,
                    {"operation": operation_type, "function": func.__name__, "status": "success"},
                )
                ...
                app_metrics.increment_counter(
                    "database_queries_total",
                    1,
                    {"operation": operation_type, "function": func.__name__, "status": "error"},
                )
...
def _sanitize_args(args, kwargs):
    ...
    sanitized = {"args_count": len(args), "kwargs_keys": list(kwargs.keys())}
...
# Export decorators
__all__ = ["log_service_call", "log_business_event", "log_security_event", "log_database_query"]
