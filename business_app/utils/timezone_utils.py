...
def format_datetime_for_user(
    dt: datetime, format_string: Optional[str] = None, timezone_tz: Optional[Union[str, pytz.BaseTzInfo]] = None
) -> str:
    """
...
def parse_user_datetime(
    dt_string: str, format_string: Optional[str] = None, source_tz: Optional[Union[str, pytz.BaseTzInfo]] = None
) -> datetime:
    """
...
def is_business_hours(dt: Optional[datetime] = None, tz: Optional[Union[str, pytz.BaseTzInfo]] = None) -> bool:
    """
