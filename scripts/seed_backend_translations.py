...
ADMIN_UI_BACKFILL_TRANSLATIONS = {
    ...
    'ui.users.cart': _ui_tr('Cart', 'Savat', 'Корзина'),
    'ui.users.cart_product': _ui_tr('Product', 'Mahsulot', 'Товар'),
    'ui.users.cart_quantity': _ui_tr('Quantity', 'Miqdori', 'Количество'),
    'ui.users.cart_unit_price': _ui_tr('Unit price', 'Birlik narxi', 'Цена за единицу'),
    'ui.users.cart_line_total': _ui_tr('Line total', 'Qator jami', 'Сумма строки'),
    'ui.users.cart_item_count': _ui_tr('Items', 'Mahsulotlar', 'Товаров'),
    'ui.users.cart_subtotal': _ui_tr('Subtotal', 'Oraliq jami', 'Подытог'),
    'ui.users.cart_total': _ui_tr('Estimated total', 'Taxminiy jami', 'Примерный итог'),
    'ui.users.cart_updated_at': _ui_tr('Last updated', 'Oxirgi yangilanish', 'Последнее обновление'),
    'ui.users.cart_empty': _ui_tr('Cart is empty.', 'Savat bo\'sh.', 'Корзина пуста.'),
    'ui.users.cart_load_failed': _ui_tr('Failed to load cart', 'Savatni yuklab bo\'lmadi', 'Не удалось загрузить корзину'),
