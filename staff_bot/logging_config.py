"""
Logging configuration for the Staff Bot
"""
import logging
...
def setup_logging(log_level="INFO", log_to_file=False, log_file_path="staff_bot.log"):
    """Setup logging configuration for the staff bot"""
    ...
    print(f"Staff Bot logging configured - Level: {log_level}, File: {log_to_file}")
    return root_logger


def log_bot_startup_info():
    """Log important staff bot startup information"""
    ...
    logger.info(f"Max Active Deliveries: {config.staff.max_active_deliveries_per_person}")
